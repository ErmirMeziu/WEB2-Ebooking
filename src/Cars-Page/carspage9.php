...
<body>
    ...
    <div class="price4">
        <h1>Audi Q8</h1>
        <h1><span id="dailyCost">396</span>€ / <span style="color: orange;">DAY</span></h1>
    </div>

    <section class="all">
        <div class="container20">
            <div class="slide20">
                <div class="item" style="background-image: url(../images/Cars/audiQ8/audiQ8-1.jpg);">
                </div>
                <div class="item" style="background-image: url(../images/Cars/audiQ8/audiQ8-2.jpg);">

                </div>
                <div class="item" style="background-image: url(../images/Cars/audiQ8/audiQ8-3.webp);">
        ...
        <div class="right2">
            <div class="car-features">
                <h3>Car features</h3>
                <p><i class="fa-solid fa-wind" style="margin-right: 13px;"></i>Air Conditioning</p>
                <div style="display: flex;">
                    <img src="../images/Cars/Doors.png" alt="" width="40" height="40"
                        style="position: relative; right: 10px;">
                    <p style="position: relative; right: 4px; top: 5px;">5 Doors</p>
                </div>
                <div style="display: flex;">
                    <img src="../images/Cars/Automatike.webp" alt="" width="50" height="50"
                        style="position: relative; right: 15px;">
                    <p style="position: relative; right: 15px; top: 10px;">Transmission Automatic</p>
                </div>
            </div>
            <div class="Capacity">
                <h3>Capacity</h3>
