...
<body class="body">
    ...
    <div class="body-part">
        <div class="sec1">
            ...
            <div class="pin-text">
                <p><i class="fa-solid fa-location-dot"></i> 51 Imbiah Walk Sentosa, Sentosa Island, 099538 Singapore,
                    Singapore <a
                        href="https://www.google.com/maps/place/Siloso+Beach+Resort/@1.2554317,103.8144827,21z/data=!4m9!3m8!1s0x31da1bf9860bf3d9:0xe10e5664bab57819!5m2!4m1!1i2!8m2!3d1.2549599!4d103.8144917!16s%2Fg%2F1thg7zhs?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D"
                        target="_blank"> -Great location - show map</a></p>
                <button id="btn-res">Reserve</button>
            </div>

            <div class="photos">
                <img src="../images/hotel siloso beach resort/Outside.jpg" alt="Hotel img" class="photo"
                    id="first-photo">
                <img src="../images/hotel siloso beach resort/Room.jpg" alt="Hotel img" class="photo" id="second-photo">
                <img src="../images/hotel siloso beach resort/View.jpg" alt="Hotel img" class="photo" id="third-photo">
                <div class="bottom-photos">
                    <img src="../images/hotel siloso beach resort/Pool.jpg" alt="Hotel img" class="bottom-pht">
                    <img src="../images/hotel siloso beach resort/Gym.jpg" alt="Hotel img" class="bottom-pht">
                    <img src="../images/hotel siloso beach resort/Animals.jpg" alt="Hotel img" class="bottom-pht">
                    <img src="../images/hotel siloso beach resort/Bathroom.jpg" alt="Hotel img" class="bottom-pht">
                    <img src="../images/hotel siloso beach resort/Food.jpg" alt="Hotel img" class="bottom-pht">
                </div>
            </div>

            <div class="some-txt">
                <p>Offering tranquillity and a rustic environment, Siloso Beach Resort is an award-winning eco resort
                    boasting a landscaped spring water pool with slides for children on Sentosa Island. Surrounded by
                    lush greenery, the resort offers selected rooms with South China Sea views.
                </p><br>
                <p>Siloso Beach Resort is a 5-minute walk from Sentosa Luge and Skyride, *AJ Hackett offering bungy jump
                    and giant swing experiences and the Beach Station. Vivocity and Harbourfront MRT station is three
                    Sentosa Express stops away.
                </p><br>
                <p>Rooms at the resort are fitted with flat-screen cable TVs and internet access. Tea/coffee makers are
                    provided, with select rooms offering minibars. Safety deposit boxes and hairdryers are included.</p>
                <br>
                <p>Complimentary eco tours are subject to availability. A dip in the hot tub can be enjoyed in the
                    resort itself.
                    The resort offers self-service laundry and drying facilities.</p><br>

                <div id="extra-text" class="hidden">
                    <p>Local dishes can be enjoyed at EAC@SBR located on Level One (Beach level). A variety of local and
                        western
                        cuisine is offered on the menu.</p><br>
                    <p>Couples particularly like the location — they rated it 8.5 for a two-person trip.</p>
                </div>
        ...
        <div class="sec2">
            ...
            <div class="map-container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.8135746808155!2d103.8144827!3d1.2549599!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da1bf9860bf3d9%3A0xe10e5664bab57819!2sSiloso%20Beach%20Resort!5e0!3m2!1sen!2ssg!4v1693005872123!5m2!1sen!2ssg"
            ...
            <div class="ask-first">
                <ol>
                    <li>
                        ...
                        <p class="answer">There is a swimming pool at Siloso Beach Resort - Sentosa.
                    ...
                    <li>
                        ...
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">Breakfast is available for an additional fee.</p>
                    </li>
                    <hr>
                    <li>
                        Is there a restaurant?
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">There is a restaurant at Siloso Beach Resort - Sentosa.</p>
                    </li>
                    <hr>
                    <li>
                        Is there a spa?
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">Unfortunately, there is no spa or wellness centre at Siloso Beach Resort -
                            Sentosa.</p>
                    </li>
                    <hr>
                    <li>
                        Can I park there?
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">This is what Siloso Beach Resort - Sentosa says about parking:
                            No parking available.</p>
                    </li>
                </ol>
            </div>
            ...
            <div class="ask-first">
                <ol style="list-style-type: upper-roman;">
                    <li>
                        ...
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">To find out what’s near Siloso Beach Resort - Sentosa, click the link below.
                            <a href="#hotel-sorroun">See property surroundings</a>
                        </p>
                    </li>
                    <hr>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">Siloso Beach Resort - Sentosa doesn't have rooms with a hot tub.</p>
                    </li>
                    <hr>
                    <li>
                        Is there an airport shuttle service?
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">Airport shuttle service is not available at Siloso Beach Resort - Sentosa.</p>
                    </li>
                    <hr>
                    <li>
                        What are the check-in and check-out times?
                        <span class="arrow">&#x25BC;</span>
                        <p class="answer">✓ Check-in from 15:00
