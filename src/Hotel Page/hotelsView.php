...
<body class="body">
    ...
    <div class="body-part">
        <div class="sec1">
            ...
            <div class="pin-text">
                <p><i class="fa-solid fa-location-dot"></i> <?php echo htmlspecialchars($hotel['address'] . ', ' . $hotel['city'] . ', ' . $hotel['country']); ?>
                    <a href="https://www.google.com/maps/place/Hotel+Chancellor/@1.3149209,103.8118214,13.59z/data=!4m9!3m8!1s0x31da199656c10c63:0x7634e84074996b35!5m2!4m1!1i2!8m2!3d1.3011349!4d103.8421518!16s%2Fg%2F11cjj86261?entry=ttu&g_ep=EgoyMDI0MTIwOS4wIKXMDSoASAFQAw%3D%3D" target="_blank"> -Great location - show map</a>
                </p>
            ...
            <div class="photos">
                <?php foreach ($main_photos as $index => $imgurl): ?>
                    <img src="<?php echo htmlspecialchars($imgurl); ?>" alt="Hotel img" class="photo" id="<?php echo ['first-photo', 'second-photo', 'third-photo'][$index]; ?>">
                <?php endforeach; ?>
                ...
                <?php foreach ($rooms as $index => $room): ?>
                    <tr draggable="true" id="room<?php echo $index + 1; ?>">
                        <td>
                            ...
                            <i class="fa-solid fa-<?php echo strpos($room['bed_configuration'], 'single') !== false ? 'user-group' : 'bed'; ?>"></i>
                        </td>
                        <td class="guest-info">
                ...
                <?php foreach ($reviews as $review): ?>
                    <div class="category">
                        ...
                        <div class="bar-container">
                            <div class="bar bar-<?php echo $review['rating'] >= 7 ? 'blue' : 'red'; ?>" style="width: <?php echo $review['rating'] * 10; ?>%;"></div>
                        </div>
